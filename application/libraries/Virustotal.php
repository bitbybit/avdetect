...
class Virustotal {
	...
	public function scanFile($filePath) {
		...
		return $this->_doCall(self::URL_SCAN_FILE, $parameters);
	}
	...
	public function getFileReport($resource) {
		...
		return $this->_doCall(self::URL_FILE_REPORT, $parameters);
	}
	...
	public function scanURL($URL) {
		...
		return $this->_doCall(self::URL_SCAN_URL, $parameters);
	}
	...
	public function getURLReport($resource, $scan = FALSE) {
		...
		return $this->_doCall(self::URL_URL_REPORT, $parameters);
	}
	...
	public function makeComment($resource, $comment) {
		...
		return $this->_doCall(self::URL_MAKE_COMMENT, $parameters);
	}
	...
	*/
	...
	private function _doCall($apiTarget, $parameters) {
		...
		$ch = curl_init(self::URL_API_BASIS . $apiTarget);
